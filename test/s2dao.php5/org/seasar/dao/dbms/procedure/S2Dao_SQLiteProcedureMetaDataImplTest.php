 ...
 * @author nowel
 */
class S2Dao_SQLiteProcedureMetaDataImplTest extends PHPUnit2_Framework_TestCase {
    
    private $pmeta = null;

    public static function main() {
        $suite  = new PHPUnit2_Framework_TestSuite("S2Dao_SQLiteProcedureMetaDataImplTest");
    ...
    protected function setUp() {
        ...
        $this->pmeta = new S2Dao_SQLiteProcedureMetaDataImpl($dataSource->getConnection(),
                                                            new S2Dao_SQLite());
    }
    ...
    public function testGetProcedureColumnsIn4() {
        ...
        $this->assertEquals($columnIn[1]->getName(), "tax");
        $this->assertEquals($columnIn[1]->getInout(), S2Dao_ProcedureMetaData::INTYPE);
        $this->assertEquals($columnIn[2]->getName(), "total");
        $this->assertEquals($columnIn[2]->getInout(), S2Dao_ProcedureMetaData::INTYPE);
    }
