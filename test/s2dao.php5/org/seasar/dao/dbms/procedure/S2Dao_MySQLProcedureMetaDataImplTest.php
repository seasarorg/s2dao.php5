 ...
 * @author nowel
 */
class S2Dao_MySQLProcedureMetaDataImplTest extends PHPUnit2_Framework_TestCase {

    private $pmeta = null;

    public static function main() {
        $suite  = new PHPUnit2_Framework_TestSuite("S2Dao_MySQLProcedureMetaDataImplTest");
    ...
    protected function setUp() {
        ...
        $this->pmeta = new S2Dao_MySQLProcedureMetaDataImpl($dataSource->getConnection(),
                                                            new S2Dao_MySQL());
    }
