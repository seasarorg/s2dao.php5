 ...
 * @author nowel
 */
abstract class AbstractBeanMetaDataResultSetHandler implements ResultSetHandler {
    ...
    protected function createRow($rs, $columnNames){
    ...
    protected function createColumnNames(ResultSetMetaData $rsmd){
