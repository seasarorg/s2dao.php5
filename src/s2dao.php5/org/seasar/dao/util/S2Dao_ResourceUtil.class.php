...
final class S2Dao_ResourceUtil {
    ...
    private function S2Dao_ResourceUtil() {
    }
    ...
    public static function getResource($path, $extension = null) {
        if( $extension == null ){
            ...
            if ($url != null) {
                ...
                throw new S2Container_ResourceNotFoundRuntimeException($this->getResourcePath($path, $extension));
            }
        }
    }
    ...
    public static function getProperties($path) {
        ...
        try {
            ...
            throw new S2Container_IORuntimeException(ex);
        }
    }
    ...
    public static String toExternalForm(URL url) {
        ...
        try {
            ...
            ex.printStackTrace();
            throw new S2Container_RuntimeException(ex);
        }
    }
