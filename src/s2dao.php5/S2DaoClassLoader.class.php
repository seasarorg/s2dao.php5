...
class S2DaoClassLoader {
    ...
    public static $CLASSES = array(
        ...
        'S2Dao_Firebird_DBMetaData' => '/dao/dbms/dbmeta/S2Dao_Firebird_DBMetaData.class.php',
        'S2Dao_Oracle_DBMetaData' => '/dao/dbms/dbmeta/S2Dao_Oracle_DBMetaData.class.php',
        'S2Dao_SQLite_DBMataData' => '/dao/dbms/dbmeta/S2Dao_SQLite_DBMataData.class.php',
        'S2Dao_PostgreSQL_DBMetaData' => '/dao/dbms/dbmeta/S2Dao_PostgreSQL_DBMetaData.class.php',
        'S2Dao_Standard_DBMetaData' => '/dao/dbms/dbmeta/S2Dao_Standard_DBMetaData.class.php',
