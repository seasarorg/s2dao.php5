...
class S2DaoClassLoader {
    ...
    public static $CLASSES = array(
        ...
        'PagerS2DaoInterceptorWrapper' => '/dao/pager/PagerS2DaoInterceptorWrapper.class.php',
        'DefaultPagerCondition' => '/dao/pager/DefaultPagerCondition.class.php',
        'PagerResultSetWrapper' => '/dao/pager/PagerResultSetWrapper.class.php',
