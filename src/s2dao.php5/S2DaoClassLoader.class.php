...
class S2DaoClassLoader {
    ...
    public static $CLASSES = array(
        ...
        'S2Dao_DBMetaData' => '/dao/S2Dao_DBMetaData.class.php',
        ...
        'S2Dao_Sybase' => '/dao/dbms/S2Dao_Sybase.class.php',
        'S2Dao_Standard' => '/dao/dbms/S2Dao_Standard.class.php',
        'S2Dao_MySQLProcedureMetaDataImpl' => '/dao/dbms/procedure/S2Dao_MySQLProcedureMetaDataImpl.class.php',
        'S2Dao_OracleProcedureMetaDataImpl' => '/dao/dbms/procedure/S2Dao_OracleProcedureMetaDataImpl.class.php',
        'S2Dao_PostgreSQLProcedureMetaDataImpl' => '/dao/dbms/procedure/S2Dao_PostgreSQLProcedureMetaDataImpl.class.php',
        'S2Dao_SQLiteProcedureMetaDataImpl' => '/dao/dbms/procedure/S2Dao_SQLiteProcedureMetaDataImpl.class.php',
        'S2Dao_ProcedureMetaDataFactory' => '/dao/dbms/procedure/S2Dao_ProcedureMetaDataFactory.class.php',
        'S2Dao_ProcedureInfo' => '/dao/dbms/procedure/S2Dao_ProcedureInfo.class.php',
        'S2Dao_ProcedureType' => '/dao/dbms/procedure/S2Dao_ProcedureType.class.php',
        'S2Dao_DBMetaDataFactory' => '/dao/dbms/dbmeta/S2Dao_DBMetaDataFactory.class.php',
        'S2Dao_FirebirdDBMetaData' => '/dao/dbms/dbmeta/S2Dao_FirebirdDBMetaData.class.php',
        'S2Dao_OracleDBMetaData' => '/dao/dbms/dbmeta/S2Dao_OracleDBMetaData.class.php',
        'S2Dao_PostgreSQLDBMetaData' => '/dao/dbms/dbmeta/S2Dao_PostgreSQLDBMetaData.class.php',
        'S2Dao_SQLiteDBMetaData' => '/dao/dbms/dbmeta/S2Dao_SQLiteDBMetaData.class.php',
        'S2Dao_SybaseDBMetaData' => '/dao/dbms/dbmeta/S2Dao_SybaseDBMetaData.class.php',
        'S2Dao_StandardDBMetaData' => '/dao/dbms/dbmeta/S2Dao_StandardDBMetaData.class.php',
        ...
        'S2Dao_TableNotFoundRuntimeException' => '/dao/exception/S2Dao_TableNotFoundRuntimeException.class.php',
        ...
        'S2Dao_LimitOffsetS2DaoInterceptor' => '/dao/pager/S2Dao_LimitOffsetS2DaoInterceptor.class.php',
        'S2Dao_SelectDynamicCommandLimitOffsetWrapper' => '/dao/pager/S2Dao_SelectDynamicCommandLimitOffsetWrapper.class.php',
        'S2Dao_SelectDynamicCommandLimitOffsetWrapperFactory' => '/dao/pager/S2Dao_SelectDynamicCommandLimitOffsetWrapperFactory.class.php',
